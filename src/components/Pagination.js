            ...
            <form className="my-page-form">
                <div className="row">
                    ...
                    <div className="col">
                        ...
                        <input type="number" id="typeNumber" className="form-control number" value={this.props.pageSize} min="1" max={this.props.totalHumanBeings} onChange={(e)=>this.handleSizeUpdate(e.target.value)}/>
                    </div>
                </div>
